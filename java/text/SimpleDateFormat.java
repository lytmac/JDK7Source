 ...
 *
 * The original version of this source code and documentation is copyrighted and owned by Taligent, Inc., a wholly-owned subsidiary of IBM.
 * These materials are provided under terms of a License Agreement between Taligent and Sun. This technology is protected by multiple US
 * and International patents. This notice and attribution to Taligent may not be removed.
 *
 ...
 * the applyPattern methods as desired. 
 ...
 * Within date and time pattern strings, unquoted letters from 'A' to 'Z' and from 'a' to 'z' are interpreted as pattern letters representing the
 * components of a date or time string. Text can be quoted using single quotes ' to avoid interpretation.
 ...
 *     For example, using a pattern of "MM/dd/yy" and a SimpleDateFormat instance created on Jan 1, 1997, the string "01/11/12" would be interpreted
 *     as Jan 11, 2012 while the string "05/04/64" would be interpreted as May 4, 1964.
 ...
 *     Any other numeric string, such as a one digit string, a three or more digit string, or a two digit string that isn't all digits (for example, "-1"),
 *     is interpreted literally. So "01/02/3" or "01/02/003" are parsed, using the same pattern, as Jan 2, 3 AD. Likewise, "01/02/-3" is parsed as Jan 2, 4 BC.
 *     Otherwise, calendar system specific forms are applied.
 *     For both formatting and parsing, if the number of pattern letters is 4 or more, a calendar specific long form} is used. Otherwise, a calendar
 *     specific short or abbreviated form is used.
 *     If week year 'Y' is specified and the calendar doesn't support any week years, the calendar year 'y' is used instead. The
 ...
 * In these strings, the pattern letters described above may be replaced with other, locale dependent, pattern letters.
 * SimpleDateFormat does not deal with the localization of text other than the pattern letters; that's up to the client of the class.
 *
...
public class SimpleDateFormat extends DateFormat {
     ...
     * has no defaultCenturyStart on stream.
